...
# Various plots to follow metrics
def plot_stats(figsize=(15, 10)):
...
def plot_hist():
    ...
    results_df = pd.DataFrame(data={"Wins": win, "Draws": drw, "--": loss}, index=idx)
    ...
    ax0.set_title("Wins and draws against Stockfish")
    plt.show()
